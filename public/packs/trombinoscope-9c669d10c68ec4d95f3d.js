      ...
      if (colleagueName == nameClicked) {
        ...
        if (round < team.length) {
          ...
          if (score == team.length) {
            ...
            const uniqueForgottenColleagues = Array.from(new Set(forgottenColleagues));
        ...
        forgottenColleagues.push(colleagueName);
        console.log(forgottenColleagues);
        console.log(Array.from(new Set(forgottenColleagues)));
...
/******/ });
//# sourceMappingURL=trombinoscope-9c669d10c68ec4d95f3d.js.map