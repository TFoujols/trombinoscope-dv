  ...
  button.addEventListener('click', function (e) {
    ...
    if (colleagueName == nameClicked) {
      if (round != team.length) {
        ...
        setTimeout(function () {
          button.querySelector('.point').remove('display');
        }, 600);
      } else {}
      ...
      this.querySelector('.point').classList.add('display');
      setTimeout(function () {
        button.querySelector('.point').classList.remove('display');
      }, 600);
    }
  });
});
...
/******/ });
//# sourceMappingURL=trombinoscope-abb4fa36403f280d7441.js.map