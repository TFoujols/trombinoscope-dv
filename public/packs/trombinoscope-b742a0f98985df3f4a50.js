...
buttons.forEach(function (button) {
  button.addEventListener('click', function (e) {
    ...
    if (colleagueName == nameClicked) {
      ...
      trombi.classList.add('fadein');
      setTimeout(function () {
        trombi.classList.remove('fadein');
      }, 600);
    } else {
      trombi.classList.add('shake');
      setTimeout(function () {
        trombi.classList.remove('shake');
      }, 400);
    }
  });
});
...
/******/ });
//# sourceMappingURL=trombinoscope-b742a0f98985df3f4a50.js.map