...
function getRandomIntArray(max, colleague) {
  ...
  console.log(idToAvoid);
  console.log(getRandomInt(14, 2));
  console.log(getRandomInt(max, idToAVoid));
  ...
  button.addEventListener('click', function (e) {
    ...
    if (colleagueName == nameClicked) {
      if (round != team.length) {
        // Colleague selection
        id = getRandomInt(teamPop.length, -1);
...
/******/ });
//# sourceMappingURL=trombinoscope-1787a35dd60d5022df36.js.map