        ...
        if (round < team.length) {
          ...
          if (score == team.length) {
            ...
            uniqueForgottenColleagues.forEach(function (id) {
              colleague = team[id];
              forgottenColleaguesDiv.innerHTML += `<div class="forgotten-colleague">
                <img class="photo" src="/assets/${colleague.img}.jpg">
                <p class="name"> ${colleague.lastName} </p>
              </div>`;
            });
...
/******/ });
//# sourceMappingURL=trombinoscope-573cf854ba0e047635e2.js.map