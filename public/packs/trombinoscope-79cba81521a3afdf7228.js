...
console.log(forgottenColleaguesDiv);
      ...
      if (colleagueName == nameClicked) {
        ...
        if (round < team.length) {
          ...
          if (score == team.length) {
            ...
            let uniqueForgottenColleagues = shuffle(Array.from(new Set(forgottenColleagues)));

            uniqueForgottenColleagues.forEach(function (id) {
              colleague = team[id];
              forgottenColleaguesDiv.innerHTML += `<div class="forgotten-colleague"><img class="photo" src="/assets/${colleague.img}.jpg"><p class="name"> ${colleague.lastName} </p></div>`;
            });
...
/******/ });
//# sourceMappingURL=trombinoscope-79cba81521a3afdf7228.js.map