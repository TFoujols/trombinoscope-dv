...
console.log(forgottenColleaguesImg);
      ...
      if (colleagueName == nameClicked) {
        ...
        if (round < team.length) {
          ...
          if (score == team.length) {
            ...
            let uniqueForgottenColleagues = shuffle(Array.from(new Set(forgottenColleagues))).slice(0, 3);
            forgottenColleaguesImg.forEach(function (img, index) {
              colleague = team[uniqueForgottenColleagues[index]];
              img.src = `/assets/${colleague.img}`;
            });
...
/******/ });
//# sourceMappingURL=trombinoscope-ea2b4a2aaf91a4c00de5.js.map