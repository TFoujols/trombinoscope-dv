...
buttons.forEach(function (button) {
  button.addEventListener('click', changeNames);
});

function changeNames() {
  name = self.querySelectorAll("p")[0].text;
  lastName = self.querySelectorAll("p")[1].text;
  console.log(name);
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-e722e20a53f5e9d3324d.js.map