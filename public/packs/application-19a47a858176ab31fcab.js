...
buttons.forEach(function (button) {
  ...
  button.addEventListener('click', changeNames(self));
});

function changeNames(button) {
  name = button.querySelectorAll("p")[0].text;
  lastName = button.querySelectorAll("p")[1].text;
  console.log(name);
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__trombinoscope__ = __webpack_require__(/*! ./trombinoscope */ 1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__trombinoscope___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__trombinoscope__);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-19a47a858176ab31fcab.js.map