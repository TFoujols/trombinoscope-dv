...
function namesDisplay() {
  ...
  ids = getRandomIntArray(10);
  colleagues = [team[ids[0]], team[ids[1]], team[ids[2]]];
  console.log(colleagues);
  // Update buttons
  buttons.forEach(function (button) {
    let i = 0;
    this.querySelector(".name").innerText = colleagues[i].name;
    this.querySelector(".last-name").innerText = colleagues[i].lastName;
    i++;
  });
}
...
/******/ });
//# sourceMappingURL=trombinoscope-c09c6ae6f03d89be26b1.js.map